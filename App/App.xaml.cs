...
{
    public static IntPtr dmc = IntPtr.Zero;
    ...
    public static settingsDataType settings = new();
    ...
    { //Took from Lycol50's contribution at BirdyFences.
        [DllImport("user32.dll")]
        ...
        public static void MakeWindowPersistent(Window window)
        {
            window.SourceInitialized += (s, e) =>
            {
                ...
                SetCurrentProcessExplicitAppUserModelID("OrangemiumDock");
        ...
        //Code from Simon Mourier from Stack Overflow. https://stackoverflow.com/questions/32122679/getting-icon-of-modern-windows-app-from-a-desktop-application/36559301#36559301
        /*
    ...
    protected override void OnStartup(StartupEventArgs e)
    {
        if (e.Args.Contains("--desktop")) {
            ...
            VirtualDesktopHelper.MakeWindowPersistent(d);
